/**
* @Date:   2017-01-24T19:08:24-06:00
* @Last modified time: 2017-03-03T00:54:49-06:00
...
import { PropertySuggestionComponent } from '../../../chat-extensions/property-suggestion/property-suggestion.component'
...
@Component({
  ...
  trigger('flyInOut', [
    ...
    transition('void => inRight', [
      ...
      animate('125ms cubic-bezier(0, .7, 0.5, 1)')
    ]),
    ...
    transition('inLeft => void', [
      animate('250ms 500ms cubic-bezier(.7, 0, 1, .5)', style({transform: 'translateX(-100%)'}))
    ])
  ])
]
})
